...
```{r tourism-purpose-plot-output, ref.label="tourism-purpose-plot", echo=FALSE, cache=TRUE}
```
...
```{r tourism-purpose-seasonplot-output, echo = FALSE, eval = TRUE, fig.height=8}
library(feasts)
aus_travel %>% 
  gg_season(Trips) + 
...
### Representing time series with features
