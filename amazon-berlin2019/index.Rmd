...
### 25 June 2019
### Slides @ [slides.mitchelloharawild.com/amazon-berlin2019](https://slides.mitchelloharawild.com/amazon-berlin2019)
]
...
```{r graphics4, fig.width=5, fig.height=8, echo = TRUE, out.width = "350px"}
...
`r fa("desktop", fill = "white")` Review slides: [slides.mitchelloharawild.com/amazon-berlin2019](https://slides.mitchelloharawild.com/amazon-berlin2019)
